...
![横幅](https://placehold.jp/800x200.png?text=部署页面)
...
![横幅](https://placehold.jp/800x200.png?text=步骤有待验证)
...
VITE_SUPABASE_SHARE_URL=共享库Supabase地址
VITE_SUPABASE_SHARE_ANON_KEY=共享库AnonKey
```
